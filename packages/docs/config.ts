...
const presetConfig: Options = {
  docs: {
    ...
    editUrl:
      'https://github.com/BuDingOwO/chronocat/tree/master/packages/docs',
  },
  ...
  specs: [
    {
      ...
      url: 'https://chronocat-docs.vercel.app/openapi.yaml',
    ...
    },
    {
      ...
      url: 'https://chronocat-docs.vercel.app/openapi-config.json',
    },
  ],
  theme: {
    primaryColor: '#2e8555',
...
const themeConfig: ThemeConfig = {
  ...
  navbar: {
    ...
    items: [
      ...
      {
        href: 'https://github.com/BuDingOwO/chronocat',
...
export const config: Config = {
  ...
  url: 'https://chronocat-docs.vercel.app',
  baseUrl: '/',
